      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-800 dark:text-white">Samuel Desenvolvedor Web</span>
          </div>
          <Link 
                href="/login" 
          ...
          <Link 
              ...
              >
               ...
               <div className="flex items-center space-x-3">
                ...
                <div className="p-2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
                  <a href="https://www.linkedin.com/in/samuelsantana-dev">Linkedin</a>
                </div>
              </div>
        </div>
      </div>
